...
* Feature 1: Initial listing. The initial page is meant to display LaptopManufacturer laptops in a list. You need to retrieve this from the server. 
...
If it runs, you should see the LaptopManufacturer page but without any records. That's what you'll work on in the assignments below. Now you can go to the GitHub issues and start knocking them down!
